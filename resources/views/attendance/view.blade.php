    ...
    <div id="content-container">
        ...
        <div id="page-content">
            <div class="row">
                ...
                {{-- preachers attendance --}}
                <div class="col-md-offset-1 col-md-10" style="margin-bottom:50px">
                  <div class="panel rounded-top" style="background-color: #e8ddd3;">
                      <div class="panel-heading">
                          <h1 class="panel-title text-center">Preacher's Attendance<h1>
                      </div>
                      <div class="panel-body text-center clearfix table-response">
                          <table id="demo-dt-basic" class="table table-striped table-bordered datatable" cellspacing="0"
                              width="100%">
                              <thead>
                                  <tr>
                                      <th>S/N</th>
                                      <th class="min-tablet">Preacher Name</th>
                                      <th class="min-tablet">Service Type</th>
                              ...
                              <tbody>
                                  ...
                                  @foreach ($preacher as  $preachers)
                                      <tr>
                                          <td><strong>{{ $count }}</strong></td>
                                          <td>{{ ucwords($preachers->preachername) }}</td>
                                          <td>{{ ucwords( $preachers->service_types->name) }}</td>
                                          <td>{{ ucwords($preachers->attendance_date) }}</td>
                                          {{-- <td>
                                              <button data-fullname="{{ $member->getFullname() }}"
                                                  data-id="{{ $member->id }}"
                                                  class="btn btn-primary show-member-history fa fa-eye"> View</button>
                ...
                <div class="col-md-offset-1 col-md-10" style="margin-bottom:50px">
                  <div class="panel rounded-top" style="background-color: #e8ddd3;">
                      <div class="panel-heading">
                          <h1 class="panel-title text-center">Topics Preached<h1>
                      </div>
                      <div class="panel-body text-center clearfix table-response">
                          <table id="demo-dt-basic" class="table table-striped table-bordered datatable" cellspacing="0"
                              width="100%">
                              ...
                              <tbody>
                                  ...
                                  @foreach ($topics  as  $topic)
                                      <tr>
                                          <td><strong>{{ $count }}</strong></td>
                                          <td>{{ ucwords($topic->topic) }}</td>
                                          <td>{{ ucwords( $topic->service_types->name) }}</td>
                                          <td>{{ ucwords($topic->attendance_date) }}</td>
                                          {{-- <td>
                                              <button data-fullname="{{ $member->getFullname() }}"
                                                  data-id="{{ $member->id }}"
                                                  class="btn btn-primary show-member-history fa fa-eye"> View</button>
