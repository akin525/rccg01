...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Mark Group Attendance</h1>
            </div>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End page title-->
        ...
        <div id="page-content">
            ...
            <div class="col-md-12 col-md-offset-0 col-lg-8 col-lg-offset-1" style="margin-bottom:20px">
                <div class="panel rounded-top" style="background-color: #e8ddd3;">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Mark Group Attendnace</h3>
                    </div>
                    <!-- if service types not exists -->
                    @if (!count($services) > 0)
                        <div class="col-12 well text-center bg-danger">
                    ...
                    @else
                        <!--Block Styled Form -->
                        <!--===================================================-->
                        <form id="b-attendance-form" method="POST" action="{{ route('attendance.group.mark') }}">
                            @csrf
                            <input name="branch_id" value="3" type="text" hidden="hidden" />
                            <div class="panel-body">
                                <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <select name="group" id="mark-select" class="selectpicker"
                                            data-style="btn-success" required>
