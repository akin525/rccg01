    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <div class="text-center">
                <h3>Welcome to <strong>{{ env('APP_NAME') }}</strong> Dashboard.</h3>
        ...
        <div id="page-content">
                                        ...
                                        <tr>
                                            <td class="text-lg" style="width: 40px">
                                                <span class="badge badge-purple"
                                                    style="background-color: {{ $colors[0] }}">{{ $total['male'] }}</span>
                                            </td>
                                            <td>Male</td>
                                        </tr>
                                        <tr>
                                            <td class="text-lg">
                                                <span class="badge badge-dark"
                                                    style="background-color: {{ $colors[1] }}">{{ $total['female'] }}</span>
                                            </td>
                                            <td>Female</td>
                                        </tr>
                                        <hr>
                                            ...
                                            <td>
                                                <div class="text-sm">
                                                    <p class="text-5x text-thin text-main mar-no"><span
                                                            class="badge badge-primary">{{ $total['members'] }}</span></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
            ...
            {{--              <h3 class="panel-title"><strong>Upcoming Wedding(s) For <?php echo date('Y');
            $i = 1; ?></strong> </h3> --}}
            ...
            {{--  <div class="row"> --}}
            <?php
            //$eventss = []; foreach ($events as $event);
            // if($event->date >= now())
