...
@section('title') Register Building Offering @endsection
...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Add Building Offering Amount For Today</h1>
            </div>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End page title-->
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Building Offering</li>
            </ol>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End breadcrumb-->
        ...
        <div id="page-content">
            ...
            <div class="col-md-12 col-md-offset-0 col-lg-8 col-lg-offset-1" style="margin-bottom:20px">
                <div class="panel rounded-top" style="background-color: #e8ddd3;">
                    ...
                    <form id="b-attendance-form" method="POST" action="{{ route('financial.buildingoffering') }}">
                        @csrf
