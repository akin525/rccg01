...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">WhatsApp Messaging</h1>
            </div>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End page title-->
                ...
                <div class="col-sm-6 col-sm-offset-3" style="margin-bottom:420px">
                    <div class="panel" style="background-color: #e8ddd3;">
                        <div class="panel-heading">
                            <h3 class="panel-title">WhatsApp Messaging for All Members</h3>
                        </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        {{-- <div class="col-sm-12">
                                            <div class="col-lg-9">
                                                <input id="nums" type="text"
                                                    ...
                                                    class="form-control" aria-label="Recipient's Number"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-lg-9">
                                                <select id="groups-selector" data-live-search="true" name="group[]" data-width="100%"
