                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li
                                                class="{{ Route::currentRouteName() === 'attendance.preacher' ? 'active-sub active' : '' }}">
                                                <a href="{{ route('attendance.preacher') }}"><i
                                                        class="fa fa-save"></i>Preacher's
                                                    Attendance</a>
                                            </li>
                                            <li
                                                class="{{ Route::currentRouteName() === 'attendance.topicpreached' ? 'active-sub active' : '' }}">
                                                <a href="{{ route('attendance.topicpreached') }}"><i
                                                        class="fa fa-save"></i> Topic Preached</a>
                                            </li>
                                            <li
                                    ...
                                    <li
                                        class="{{ Route::currentRouteName() === 'financial.getithe' || Route::currentRouteName() === 'financial.getoffering' ? 'active-sub active' : '' }}
										{{ Route::currentRouteName() === 'financial.getbuildingoffering' ? 'active-sub active' : '' }}">
                                        <a href="#">
                                            <i class="fa fa-check"></i>
                                        ...
                                        <ul class="collapse">
                                            <li
                                                class="{{ Route::currentRouteName() === 'financial.getoffering' ? 'active-sub active' : '' }}">
...
{{--                                            </li>--}}
                                    ...
                                    <li
                                        class="{{ Route::currentRouteName() === 'birthday' || Route::currentRouteName() === 'birthday' ? 'active-sub active' : '' }}
                                         {{ Route::currentRouteName() === 'birthday' ? 'active-sub active' : '' }}">
                                    ...
                                    {{ Route::currentRouteName() === 'attendance' ? 'active-sub active' : '' }}">
                                        ...
                                        <ul class="collapse">
                                            <li
                                                ...
                                                <a href="{{ route('email') }}"><i class="fa fa-save"></i>Send
                                                    Email</a>
                                            </li>

                                            <li
                                                class="{{ Route::currentRouteName() === 'sms' ? 'active-sub active' : '' }}">
                                                <a href="{{ route('sms') }}"><i class="fa fa-save"></i>Send SMS</a>
                                            </li>
                                            <li
                                                class="{{ Route::currentRouteName() === 'message.whatsapp' ? 'active-sub active' : '' }}">
                                                <a href="{{ route('message.whatsapp') }}"><i class="fa fa-save"></i>
                                                    Send WhatsApp Message</a>
                                            </li>
                                            {{-- <li
                                        class="{{ Route::currentRouteName() === 'message.indexaimessage' ? 'active-sub active' : '' }}">
                                        <a href="{{ route('message.indexaimessage') }}"><i
                                                class="fa fa-save"></i> Ai Message</a>
                                    </li> --}}
                                            {{-- <li
                                            class="{{ Route::currentRouteName() === 'attendance.view.form' ? 'active-sub active' : '' }}">
                                            <a href="{{ route('attendance.view.form') }}"><i
