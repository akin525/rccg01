...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::get('/attendance/preacher', 'AttendanceController@markpreacher')->name('attendance.preacher');
  Route::post('/attendance/preacher/store', 'AttendanceController@storepreacher')->name('attendance.preacher.store');
  Route::get('/attendance/topicpreached', 'AttendanceController@addtopic')->name('attendance.topicpreached');
  Route::post('/attendance/topic/store', 'AttendanceController@storetopic')->name('attendance.topic.store');
  Route::post('/attendance/preacher/submit', 'AttendanceController@preachersave')->name('attendance.preacher.submit');
  Route::post('/attendance/group/mark', 'AttendanceController@groupmark')->name('attendance.group.mark');
  ...
  Route::post('group/add/member', 'GroupController@add_member')->name('group.add.member');
  ...
  Route::post('/inbox/message/groupsend', 'MessagingController@sendGroupMessage')->name('sendGroupMessage');
  Route::get('/message/whatsapp', 'MessagingController@whatsapp')->name('message.whatsapp');
  Route::post('/messaging/whatsapp/send', 'MessagingController@whatsappsend')->name('whatsapp.send');
  Route::get('/messageindex/aimessage', 'MessagingController@indexaimessage')->name('message.indexaimessage');
  Route::post('/message/aimessage', 'MessagingController@aimessage')->name('message.aimessage');
  ...
  //financial
  Route::post('/financial/tithe', [FinancialController::class, 'tithe'])->name('financial.tithe');
  Route::get('/financial/getithe', [FinancialController::class, 'getithe'])->name('financial.getithe');
  Route::post('/financial/offering', [FinancialController::class, 'offering'])->name('financial.offering');
  Route::get('/financial/getoffering', [FinancialController::class, 'getoffering'])->name('financial.getoffering');
